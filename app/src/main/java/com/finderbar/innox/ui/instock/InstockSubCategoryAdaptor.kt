...
class InstockSubCategoryAdaptor(private val context: Context, private val arrayList: MutableList<SubCategory>) : RecyclerView.Adapter<InstockSubCategoryAdaptor.SubCategoryInstockViewHolder>() {
